...
#@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@##@#@#@#
    ...
    def _confirmResourceExists(self):
        ...
        if string.atoi(result) == 0:
            ...
            commands.getoutput('adb push ' + os.path() + 'resource/testalbum/ ' + '/sdcard/testalbum')
            time.sleep(2)
        else:
    ...
    def _pushResourcesVideo(self):
        ...
        if string.atoi(result2) == 0:
            commands.getoutput('adb push ' + os.path() + 'resource/testvideo/ '+'/sdcard/testvideo')
            time.sleep(2)
        commands.getoutput('adb shell am broadcast -a android.intent.action.MEDIA_MOUNTED -d file:///sdcard')
    ...
    def _push1Picture(self):
        ...
        if string.atoi(result) != 1 :
            self._clearAllResource()
            commands.getoutput('adb push ' + os.path() + 'resource/testpic1/ ' + '/sdcard/testpic1')
    ...
    def _pushConvertPicture(self):
        ...
        if string.atoi(resultNO) == 0 :
            commands.getoutput('adb push ' + os.path() + 'resource/testConvertPics/ ' + '/sdcard/testConvertPics')
        commands.getoutput('adb shell am broadcast -a android.intent.action.MEDIA_MOUNTED -d file:///sdcard')
    ...
    def _checkBurstResource(self):
        ...
        if string.atoi(resultNO) != string.atoi(resultNO1):
            self._clearAllResource()
            commands.getoutput('adb push ' + os.path() + 'resource/testburstpics/ ' + '/sdcard/DCIM/100ANDRO/')
            commands.getoutput('adb shell am broadcast -a android.intent.action.MEDIA_MOUNTED -d file:///sdcard')
